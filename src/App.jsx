...
import { Wand2, ShieldCheck, Loader2, Code2, Sparkles, ClipboardCheck, ChevronRight } from 'lucide-react';
...
`,
  ...
  return (
    <>
      <style>{`
        ...
        * { font-family: 'Outfit', sans-serif; box-sizing: border-box; }
        ...
        .btn-primary {
          ...
          padding: 0 18px; height: 42px; border-radius: 10px; border: none;
        ...
        .md-body code {
          ...
          background: #1a1a22; border: 1px solid #2d2d3a;
          border-radius: 5px; padding: 2px 7px;
          font-size: 12.5px; color: #c084fc;
        }
        .md-body pre {
          background: #111117; border: 1px solid #27272a;
          border-radius: 10px; padding: 16px;
          overflow-x: auto; margin: 14px 0;
        }
        .md-body pre code {
          background: transparent; border: none;
          color: #e2e8f0; padding: 0; font-size: 13px;
        }
        ...
        .editor-wrapper .monaco-editor .margin { background: #0e0e11 !important; }
        .editor-wrapper .monaco-editor { background: #0e0e11 !important; }
      `}</style>
      ...
      <div
        className="flex"
        style={{ height: 'calc(100vh - 72px)', background: '#0a0a0d' }}
      >
        {/* ── LEFT: Editor Panel ── */}
        <div className="flex flex-col w-1/2 border-r border-white/5">
          ...
          {/* Monaco Editor */}
          <div className="flex-1 editor-wrapper" style={{ background: '#0e0e11' }}>
            <Editor
              height="100%"
              theme="vs-dark"
              ...
              <div className="flex flex-col items-center justify-center h-full gap-6">
                ...
                <div className="flex items-center gap-2 mt-2">
                  {[0,1,2].map(i => (
                    <div
                      key={i}
                      className="pulse-dot w-2 h-2 rounded-full bg-violet-500"
            ...
            {hasReviewed && !loading && (
              <div className={animateIn ? 'response-fade-in' : 'opacity-0'}>
                ...
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <span className="text-[11px] font-semibold text-violet-400 uppercase tracking-widest">Result</span>
                ...
                <div className="mt-8 pt-5 border-t border-white/5 flex items-center justify-between">
                  <span className="text-xs text-zinc-600">Generated by Gemini · Codelyzer AI</span>
                  <div className="flex items-center gap-1 text-[11px] text-violet-400">
                    <Sparkles size={10} />
                    <span>Senior Dev Review</span>
                  </div>
                </div>
              </div>
            )}
